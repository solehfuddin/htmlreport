...
<body>
	...
	foreach ($json as $header) {
		...
		$kondisi 	= $header['conditions'];
		$diskon 	= $header['disc_sp'];
		$sales 		= $header['sales'];
		$nosp 	    = $header['orderNumber'];
		$jmlcicil 	= $header['installment'];
		$blncicil 	= $header['start_installment'];
	...
	<div>
		<h1 style="font-size:20px; padding-top:-70px; padding-left:80px;">Timur Raya Lestari</h1>
	</div>
	<div>
		<p style="font-size:9px; padding-top:-25px; padding-left:80px;">Jl. Rawa Kepiting No.4, K.I.P., Jakarta 13920, Indonesia</h1>
		</p>
		<div>
			<p style="font-size:9px; padding-top:-20px; padding-left:80px;">telp. (021) 461-0154, 461-3212 (Hunting)</h1>
			</p>
						...
						<td>
							<table>
								<tr>
									...
									<td><?php echo $pemesan['pemesanan']; ?></td>
								</tr>
								<tr>
									<td>Nama Optik</td>
									<td>:</td>
			...
			<table class="tg" width="100%" style="margin-top:18px;">
				<tr>
					...
					<th class="tg-0lax" align="center">Harga</th>
					<th class="tg-0lax" align="center">Sub Total</th>
				</tr>
				...
				?>
					...
					foreach ($json as $content) {
						$i++;
						$subtotal = $content['qty'] * $content['unit_standard_price'];
					?>
						...
						<tr>
							...
							<td class="tg-0lax" align="center">Rp. <?php echo number_format($content['unit_standard_price'], 0, '', '.'); ?></td>
							<td class="tg-0lax" align="center">Rp. <?php echo number_format($subtotal, 0, '', '.'); ?></td>
						</tr>
			...
			<table style="margin-top:10px; font-size:12px;">
				...
				<?php if ($kondisi == "Cicilan") {
				?>
					<tr>
						<td>Uang Muka</td>
						<td>:</td>
						<td>Sejumlah Rp. <?php echo number_format($dp, 0, "", "."); ?></td>
					</tr>
				<?php }; ?>
				<tr>
					<td>Discount</td>
				...
				?>
					<tr>
						...
						<td>:</td>
						<td>Cash Rp. <?php echo number_format($dp, 0, "", "."); ?></td>
					</tr>
				<?php } else { ?>
				...
				?>
					<tr>
						<td>Cicilan</td>
						<td>:</td>
						<td>Sebanyak (<?php echo $jmlcicil; ?>) Kali, Sejumlah Rp. .................... /bulan ....................</td>
					</tr>
					<tr>
						<td></td>
						<td></td>
						<td>Dimulai Sejak Bulan <?php echo "<b>" . $blncicil . "</b>"; ?> Sampai dengan Bulan ....................</td>
					</tr>
				<?php }; ?>
			</table>
			<?php if ($kondisi == "Cicilan") {
			...
			<table style="font-size:12px;">
				<tr>
					<td width="187">Alamat Pengiriman barang</td>
					<td>:</td>
					<td><?php echo $alamat; ?></td>
				</tr>
			</table>
			...
			<div>
				...
				<p style="font-size: 8px;">F-CUS-021 REV:2</p>
				
				<p style="padding-top:-190px; padding-left:460;">SALES&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CUSTOMER</p>
				<img style="padding-top:-0px; padding-left:570;" width="200px" src="<?= base_url('assets/images/signedsp/' . $header['signedpath']); ?>" alt="Paris">
				<p style="padding-top:0px; padding-left:410; font-size:11px;">Nama : <?php echo $sales; ?></p>
