  ...
  <section class="sheet padding-10mm">
    <article>
          ...
          <div class="row">
			...
			<?php 
				foreach ($json as $header) { 
					$custname 	= $header['bill_name'];
					$address  	= $header['bill_address'];
					$city		= $header['bill_kota'];
					$province 	= $header['bill_negara'];
					$username 	= $header['bill_location'];
					$purchaseorder = $header['purchase_order'];
					$ordernumber= $header['trx_number'];
					$invdate 	= $header['inv_date'];
				...
				$freight    = $total['freight'] != null ? $total['freight'] : 0;
			?>
      ...
      <table class="dataItem" style="margin-top:20; border:1px solid; font-size: 11px; text-align:center;">
		...
		?>
			<tr>
				<td style="text-align:left; "><?php echo $content['item_code']; ?></td>
					<td style="text-align:left; ">
						<?php echo $content['description']; ?>
					</td>
				<!-- <td><?php echo $content['uom_code']; ?></td> -->
				<td><?php echo 'PCS'; ?></td>
				<td><?php echo $content['qty']; ?></td>
				<td style="text-align:right;">
					<?php echo "Rp " . number_format($content['price'], 0, "", "."); ?>
				</td>
				<td style="text-align:right;">
					<?php echo "Rp " . number_format($content['price'] * $content['qty'], 0, "", "."); ?>
				</td>
			</tr>
		<?php 
			};
        ...
        <tr>
          ...
          <td></td>
          <td></td>
          <td style="text-align:right;"><?php echo "Rp " . number_format($freight, 0, "", "."); ?></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          ...
          <td></td>
          <td></td>
          <td style="text-align:right; font-size: 12px;"><?php echo "Rp " . number_format($grandTotal, 0, "", "."); ?></td>
        </tr>
      </table>
      <br>
