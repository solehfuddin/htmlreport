    ...
    <article>
			...
			<?php 
				...
				foreach ($json as $header) { 
					...
					$tinting += $header['tintingPrice'];
					$facet   = $header['facetPrice'];
				};
			?>
			...
			<table class="dataItem" style="margin-top:20; border:1px solid; font-size: 11px; text-align:center;">
				<tr style="background:#1E88E5;">
					...
					?>
						...
						<tr>
							<td style="text-align:left;">Tinting :</td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
							<td style="text-align:right;">
								<?php echo "Rp " . number_format($tinting, 0, "", "."); ?>
							</td>
						</tr>
					...
					?>
						...
						<tr>
							<td style="text-align:left;">Biaya Facet :</td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
							<td style="text-align:right;">
								<?php echo "Rp " . number_format($facet, 0, "", "."); ?>
							</td>
						</tr>
